...
def test_cli_valid_query(mock_stderr, mock_stdout, mock_parse_args):
...
@patch('sys.stdout', new_callable=MagicMock)
@patch('sys.stderr', new_callable=MagicMock)
def test_cli_invalid_query(mock_stderr, mock_stdout, mock_parse_args):
...
@patch('sys.stdout', new_callable=MagicMock)
@patch('sys.stderr', new_callable=MagicMock)
def test_cli_file_input(mock_stderr, mock_stdout, mock_parse_args):
