...
def test_valid_basic_query() -> None:
...
def test_missing_from_clause() -> None:
...
def test_multiple_filters_where_clause() -> None:
...
def test_parameters_clause() -> None:
...
def test_edge_case_string_quoting() -> None:
